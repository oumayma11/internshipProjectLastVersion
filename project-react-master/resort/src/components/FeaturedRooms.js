                ...
                <div className="featured-rooms-center">
                    <article className="room">
                        <div className="img-container">
                            ...
                            <Link to={`/suite`} className="btn-primary room-link">
                                See More
                    ...
                    <article className="room">
                        <div className="img-container">
                            ...
                            <Link to={`/vip`} className="btn-primary room-link">
                                See More
        </Link></div>
                    ...
                    <article className="room">
                        <div className="img-container">
                            ...
                            <Link to={`/double`} className="btn-primary room-link">
                                See More
        </Link></div>
                    ...
                    <article className="room">
                        <div className="img-container">
                            ...
                            <Link to={`/single`} className="btn-primary room-link">
                                See More
        </Link></div>
                    ...
                    <article className="room">
                        <div className="img-container">
                            ...
                            <Link to={`/normal`} className="btn-primary room-link">
                                See More
        </Link></div>
